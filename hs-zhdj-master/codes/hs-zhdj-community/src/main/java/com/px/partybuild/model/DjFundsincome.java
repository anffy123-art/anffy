...
public class DjFundsincome {
    ...
    private Integer budgetrevenue;

    private Integer budgetexpend;
    ...
    public Integer getBudgetrevenue() {
        return budgetrevenue;
    }

    public void setBudgetrevenue(Integer budgetrevenue) {
        this.budgetrevenue = budgetrevenue;
    }

    public Integer getBudgetexpend() {
        return budgetexpend;
    }

    public void setBudgetexpend(Integer budgetexpend) {
