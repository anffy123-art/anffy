...
public class PeBranchreview {
    private String branchreviewid;
    ...
    public String getBranchreviewid() {
        return branchreviewid;
    }

    public void setBranchreviewid(String branchreviewid) {
        this.branchreviewid = branchreviewid == null ? null : branchreviewid.trim();
    }
