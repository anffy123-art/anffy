...
public class PeRdxs {
    ...
    private Date sweartime;

    private Date progresstime;

    private String swearlocation;
    ...
    public Date getSweartime() {
        return sweartime;
    }

    public void setSweartime(Date sweartime) {
        this.sweartime = sweartime;
    }
    ...
    public String getSwearlocation() {
        return swearlocation;
    }

    public void setSwearlocation(String swearlocation) {
        this.swearlocation = swearlocation == null ? null : swearlocation.trim();
    }
