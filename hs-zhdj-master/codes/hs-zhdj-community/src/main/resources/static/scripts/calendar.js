(function (root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '</div>',
            '<a href="javascript:;" data-calendar-display-date class="calendar-display calendar-display-center">',
            ...
            '</div>',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display calendar-display-center">{yyyy}</a>',
            '<div class="calendar-arrow calendar-arrow-right">',
            /* '<span class="prev" title="上一年" data-calendar-arrow-month>{prev}</span>',*/
            '<span class="next" title="下一年" data-calendar-arrow-month>{next}</span>',
            '</div>',
